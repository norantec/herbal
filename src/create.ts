    ...
    return {
        ...
        generateClientSourceFile: () => {
            ...
            return [
                ...
                `    onRequest?: (context: { cached: boolean; options: Omit<${REQUEST_OPTIONS_NAME}, 'getAuthorizationCredential' | 'onRequest' | 'onResponse'>; prefix: string | undefined; requestBody: string; url: string; }) => void | Promise<void>;`,
