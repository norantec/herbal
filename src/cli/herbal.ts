...
const handleGetVirtualEntryFileContent: ConstructorParameters<typeof Forge>[0]['getVirtualEntryFileContent'] = (
  ...
  return [
    ...
    "import { ModelUtil, OpenAPIUtil, NestFactory, isApplication } from '@open-norantec/herbal';",
    ...
    '\n  const openAPIDocumentMap = OpenAPIUtil.generateDocumentMap({',
    '    Module: entryOptions?.Module,',
    '    groups: entryOptions?.openAPIGroups,',
    '    openAPIObject: entryOptions?.openAPIObject,',
    '    openAPIPrefix: entryOptions?.openAPIPrefix,',
    '  });',
